...
public class ChooseState extends State {
	...
	public void draw(Graphics graphics) {
		...
		graphics.drawString("Choose arena, press A, B or C", 50, 50);
		graphics.drawImage(level1, 72, 100, 300, 230, null);
		graphics.drawImage(level2, 373, 100, 300, 230, null);
		graphics.drawImage(level3, 674, 100, 300, 230, null);
