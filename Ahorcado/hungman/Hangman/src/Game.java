...
public class Game {
	...
	public boolean checkLetterIsRight(char l){
		...
		if(!isRepeated(l)){
			...
			tryAgain = true;
			System.err.print("You already tried the letter" +"'" + l + "'" + "!");
		}
	...
	public void checkForLastMove(){
		...
		if(playerGuessedLetters >= secretLetters.length){
			...
			System.out.print("**YAY! CONGRATULATIONS, YOU WIN!!!**");
			display();
			displayOptions();
            do{
	...
	public  void clearScreen(){
		...
		System.out.println("*Hangman*" + playerGuessedLetters + "/" + secretLetters.length 
				+ "         Mistakes:" + playerMistakes + "/" + hangman.length());
	}
